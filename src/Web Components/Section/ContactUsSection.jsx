...
import { sendSupport } from "../../ApiServices/Support-Web";
  ...
  return (
    <section className="ps-3 pe-3 mt-40 flex flex-col lg:gap-20 lg:px-20 lg:flex-row  md:flex-row lg:items-center md:items-center lg:mt-0 md:mt-0 pb-20 pt-20 bg-customOrange-mediumOrange relative ">
      ...
      <div className="w-full">
        <p className="text-primary text-16">{t("contactUs")}</p>
        <h1 className="font-bold text-xl mt-5">{t("getTouch")}</h1>
            ...
            <Form className="flex flex-col items-start justify-center lg:items-start md:items-start md:mt-10 w-600px">
              ...
              <div className="relative mt-2">
                <Field
                  ...
                  name="message"
                  className={`w-80 h-32 lg:w-400 md:w-400 sm:w-390 s:w-390 p-3 border-2 rounded-lg outline-none transition-all duration-200 placeholder:text-13
                    ${
              ...
              <div className="flex justify-end rtl:justify-start mt-2 w-400">
                <button
                  type="submit"
                  className="text-15 bg-primary font-bold flex justify-center items-center text-center h-12 w-52 gap-2 text-white rounded-md"
                >
                  {isLoading ? (
