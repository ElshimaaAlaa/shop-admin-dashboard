      ...
      <div className="bg-white p-5 rounded-md">
        <div className="flex justify-between items-center gap-5 bg-white rounded-md">
          ...
          <div className="flex items-center gap-5">
            <div className="bg-customOrange-mediumOrange rounded-md p-3 font-bold cursor-pointer flex items-center gap-3 w-200">
              <img
            ...
            <div
              className="flex gap-3 bg-primary text-white font-bold p-3 rounded-md cursor-pointer"
              onClick={() => navigate("/AddDiscounts")}
            >
              <div className="bg-white text-primary font-bold rounded-md ">
        ...
        {error ? (
          ...
          <div className="border rounded-md overflow-hidden mt-5">
            <table className="bg-white min-w-full table">
              <thead>
                <tr>
                  <th className="px-3 py-3 border-r text-left flex items-center gap-5">
                  ...
                  <th className="px-6 py-3 text-left w-5">Actions</th>
                </tr>
              </thead>
              <tbody>
                  ...
                  <tr key={product.id}>
                    <td className="px-3 py-3 border-t border-r">
                      <p className="flex items-center ">
                        <input
                          type="checkbox"
                          className="form-checkbox h-4 w-4 me-5"
                        />
                        <span></span>
                        <img
                          src={
                          ...
                          alt={product.name}
                          className="w-6 h-6 object-cover rounded-full me-2"
                        />
                        {product.name}
                      </p>
                    </td>
                    <td className="flex gap-3 px-6 py-3 border-t border-r cursor-pointer">
                      {product.price}
                    </td>
                    ...
                    <td className="px-6 py-3 border-t  w-10">
