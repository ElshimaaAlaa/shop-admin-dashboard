...
function DeleteMultipleInvoices({ isOpen, onClose, onConfirm, count }) {
  ...
  return (
    <FailedModal isOpen={isOpen} onClose={onClose}>
      ...
      <p className="font-bold text-center text-15">
        {t("DeleteMultipleInvoices", { count })}
      </p>
      <div
...
export default DeleteMultipleInvoices;
