...
function EditProduct() {
  return (
    <div className="bg-gray-100 flex flex-col min-h-screen">
      <h1 className="font-bold mb-3 text-2xl mx-10 mt-5 p-2">Edit Product</h1>
      <Formik>
        <Form className="flex flex-col flex-grow">
          ...
          <div className="flex gap-5 mx-10 my-5">
            ...
            <div className="bg-white rounded w-2/5 p-5">
              ...
              <Field
                placeholder="Sizes"
                className="mb-5 w-full bg-transparent outline-none border border-gray-300 rounded p-2 h-14 placeholder:text-black placeholder:font-bold"
              />
              <Field
                placeholder="Colors"
                className="w-full bg-transparent outline-none border border-gray-300 rounded p-2 h-14 placeholder:text-black placeholder:font-bold"
              />
            </div>
          </div>

          <div className="flex gap-5 items-center border-t justify-end bg-white rounded p-5 w-full mt-5">
