...
function EditProduct() {
  return (
    <div className="bg-gray-100 flex flex-col min-h-screen relative">
      <h1 className="font-bold mb-3 mx-10 mt-5 p-2" style={{fontSize:"20px"}}>Edit Product</h1>
      <Formik>
        <Form className="flex flex-col flex-grow">
          ...
          <div className="flex gap-5 mx-10 my-5">
            ...
            <div className="bg-white rounded w-2/5 p-5 h-44">
              ...
              <Field
                placeholder="Sizes"
                className="mb-3 w-full bg-transparent outline-none border border-gray-300 rounded p-2 placeholder:text-black"
              />
              <Field
                placeholder="Colors"
                className="w-full bg-transparent outline-none border border-gray-300 rounded p-2 placeholder:text-black"
              />
            </div>
          </div>
